...
echo
echo "Step 3 — simulate inbound Instagram DM (order-intent: whole honey cake, Saturday afternoon)"
PAYLOAD='{
  "type": "dm.in",
  "threadId": "ig_demo_thread_001",
  "from": "maria_lopez_demo",
  "fromName": "Maria Lopez",
  "message": "Hi! I'\''d love to pick up a whole honey cake this Saturday around 3pm. Is that doable?"
}'
curl -fsS -X POST "$WRAPPER/webhook/instagram" \
